	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="block index-block">
				<div class="header">
					<h2><i class="fa fa-user"></i> Logi sisse</h2>
				</div>
				<div class="content">
					<form action="" method="post">
						...
						<div class="form-group">
							...
							<a href="/lost" class="help-block pull-right">Kaotasid parooli?</a>
						</div>
						<div class="form-group">
						...
						<button type="submit" class="btn btn-success btn-block"><i class="fa fa-sign-in"></i> Logi sisse</button>
