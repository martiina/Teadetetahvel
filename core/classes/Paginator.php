...
class Paginator{  
    ...
    {  
        ...
        {  
            for($i=1;$i<=$this->num_pages;$i++)  
            {  
                $this->return .= ($i == $this->current_page) ? "<li class=\"active\"><a href=\"#\">$i</a></li>":"<li><a href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page\">$i</a></li>";
            }  
            $this->return .= "<li><a href=\"$_SERVER[PHP_SELF]?page=1&ipp=All\">Kõik</a></li> \n";  
        }  
